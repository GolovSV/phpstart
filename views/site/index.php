                        ...
                        <div class="product-image-wrapper">
                            <div class="single-products">
                                <div class="productinfo text-center">
                                    <img src="/template/images/home/<?php echo $product['image'];?>" alt="" style="width: 260px; height: 300px;" />
                                ...
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        ...
                                        <?php if ($sliderItem['is_new']): ?>
                                            <img src="/template/images/home/<?php echo $sliderItem['image']; ?>" class="new" alt="" style="width: 100px; height: 90px;" />
                                        <?php endif; ?>
